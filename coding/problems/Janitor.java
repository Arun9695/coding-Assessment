 ...
 public class Employee {
    ...
    public class Janitor extends Employee{
        ...
        public static void main(String[] args) {
            ...
            J.Workin();
            J.setBaseHours(40);
            J.setBaseSalary(40000.0);
            J.setBaseVacationDays(10);
            J.setBaseVacationForm("Yellow");
            System.out.println("Teachername:" +J.getHours());
            System.out.println("Teachername:" +J.getSalary());
            System.out.println("Teachername:" +J.getVacationDays());
            System.out.println("Teachername:" +J.getVacationForm());
        }
    }